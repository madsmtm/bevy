...
impl Plugin for WindowPlugin {
    fn build(&self, app: &mut App) {
        ...
        app.add_event::<WindowEvent>()
            ...
            .add_event::<WindowForeground>()
            .add_event::<WindowActivate>()
            .add_event::<WindowDeactivate>()
            .add_event::<WindowBackground>()
        ...
        app.register_type::<WindowEvent>()
            ...
            .register_type::<WindowForeground>()
            .register_type::<WindowActivate>()
            .register_type::<WindowDeactivate>()
            .register_type::<WindowBackground>()
